...
with ExitStack(lambda: sys.path.pop(0)):
    ...
    from SimpleSchema.Schema.Impl.Common.Identifier import SimpleElement
    from SimpleSchema.Schema.Impl.Statements.ItemStatement import ItemStatement, Identifier, Type
