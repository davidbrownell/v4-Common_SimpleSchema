...
def test_ErrorInvalidType():
    ...
    with pytest.raises(
        Exception,
        match=re.escape("'<class 'SimpleSchema.Schema.Elements.Types.FundamentalTypes.UnitTests.FundamentalTypeCreator_UnitTest.ComplexType'>' is not a supported python type."),
    ):
        CreateFromMetadata(
            BadType,
