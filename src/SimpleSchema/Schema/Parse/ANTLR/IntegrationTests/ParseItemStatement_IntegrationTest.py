...
with ExitStack(lambda: sys.path.pop(0)):
    from SimpleSchema.Schema.Parse.ANTLR import AntlrException
    from SimpleSchema.Schema.Parse.ANTLR.IntegrationTests.TestHelpers import CompareResultsFromFile, Test, DEFAULT_WORKSPACE_PATH
