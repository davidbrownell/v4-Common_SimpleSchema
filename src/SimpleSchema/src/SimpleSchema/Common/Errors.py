...
# |
# ----------------------------------------------------------------------
NormalizeDuplicateFlattenedItem             = DynamicSimpleSchemaException.CreateType("The name '{name}' (defined at {range}) has already been defined at {prev_range}.", name=str, range=Range, prev_range=Range)

NormalizeInvalidExtension                   = DynamicSimpleSchemaException.CreateType("The extension '{extension_name}' is not recognized.", extension_name=str)
NormalizeInvalidMetadata                    = DynamicSimpleSchemaException.CreateType("The metadata item '{name}' is not valid in this context: {desc}.", name=str, desc=str)
...
normalize_metadata_cardinality_optional     = "The type is not an optional type"
normalize_metadata_cardinality_single       = "The type is not a single type"
normalize_metadata_cardinality_zero_or_more = "The type is not a zero-or-more container type"
normalize_metadata_element_nested           = "The element is not a nested element"
normalize_metadata_element_root             = "The element is not a root element"
normalize_metadata_item                     = "The element is not an item statement"
normalize_metadata_item_nested              = "The item statement is not a nested statement"
normalize_metadata_item_root                = "The item statement is not a root statement"
normalize_metadata_structure                = "The element is not a structure statement"
normalize_metadata_structure_nested         = "The structure statement is not a nested statement"
normalize_metadata_structure_root           = "The structure statement is not a root statement"
normalize_metadata_type                     = "The element is not a type statement"
normalize_metadata_type_nested              = "The type statement is not a nested statement"
normalize_metadata_type_root                = "The type statement is not a root statement"
